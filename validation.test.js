...
describe('OpenAPIValidator', () => {
    describe('.validateRequest', () => {
        describe('path params in path base object', () => {
            const validator = new index_1.OpenAPIValidator({
                definition: Object.assign(Object.assign({}, meta), { paths: {
                        '/pets/{id}': {
                            get: {
        ...
        describe('path params with custom apiRoot', () => {
            ...
            const validator = new index_1.OpenAPIValidator({
                definition,
                router: new index_1.OpenAPIRouter({ definition, apiRoot: '/v1' }),
            });
        ...
        describe('headers', () => {
            ...
            test('passes validation for GET /secret, x-api-key:abcd0123', async () => {
                const valid = validator.validateRequest({
                    path: '/secret',
                    method: 'get',
                    headers: Object.assign(Object.assign({}, headers), { 'x-api-key': 'abcd0123' }),
                });
                expect(valid.errors).toBeFalsy();
            });
            test('fails validation for GET /secret, x-api-key:123', async () => {
                const valid = validator.validateRequest({
                    path: '/secret',
                    method: 'get',
                    headers: Object.assign(Object.assign({}, headers), { 'x-api-key': '123' }),
                });
                expect(valid.errors).toHaveLength(1);
            });
            test('fails validation for GET /secret, x-api-key:äääöööååå', async () => {
                const valid = validator.validateRequest({
                    path: '/secret',
                    method: 'get',
                    headers: Object.assign(Object.assign({}, headers), { 'x-api-key': 'äääöööååå' }),
                });
                expect(valid.errors).toHaveLength(1);
            });
        });
        describe('request payloads', () => {
            ...
            beforeAll(() => {
                validator = new index_1.OpenAPIValidator({
                    definition: Object.assign(Object.assign({}, meta), { paths: Object.assign({ '/pets': {
                                post: {
    ...
    describe('OAS formats', () => {
        describe('in request', () => {
            ...
            test('default Ajv should not warn about OAS formats in requestBody', () => {
                ...
                const construct = () => new index_1.OpenAPIValidator({
                    definition: Object.assign(Object.assign({}, meta), { paths }),
                });
                expect(construct()).toBeInstanceOf(index_1.OpenAPIValidator);
    ...
    describe('customizeAjv', () => {
        describe('using custom formats', () => {
            ...
            const customizeAjv = (ajv, ajvOpts, context) => {
                if (context === validation_1.ValidationContext.Response) {
                    // return vanilla Ajv for params validation
                    return new Ajv();
                }
                if (context === validation_1.ValidationContext.Params) {
                    // return overridden custom formats
                    return new Ajv(Object.assign(Object.assign({}, ajvOpts), { unknownFormats: ['custom'] }));
                }
                // otherwise return original ajv
                return ajv;
            };
            test('customised Ajv should throw error for unknown formats in response', () => {
                const { '/pets': { get: getPets }, } = paths;
                const warn = console.warn;
                console.warn = jest.fn();
                const construct = () => new index_1.OpenAPIValidator({
                    definition: Object.assign(Object.assign({}, meta), { paths: {
            ...
            test('customised Ajv should ignore unknown formats in params', () => {
                const { '/pets/{id}': { get: getPet }, } = paths;
                const warn = console.warn;
                console.warn = jest.fn();
                const construct = () => new index_1.OpenAPIValidator({
                    definition: Object.assign(Object.assign({}, meta), { paths: {
            ...
            test('customised Ajv should warn about unknown formats in requestBody', () => {
                const { '/pets': { post: createPet }, } = paths;
                const warn = console.warn;
                console.warn = jest.fn();
                const construct = () => new index_1.OpenAPIValidator({
                    definition: Object.assign(Object.assign({}, meta), { paths: {
